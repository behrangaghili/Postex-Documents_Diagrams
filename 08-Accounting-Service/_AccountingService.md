...
در این فرایند بعد از ثبت سفارش ابتدا پنل قرارداد را بررسی می کنیم در ابتدا به ببرسی این مورد می پردازیم که آیا ثبت سفارش توسط مشتری انجام شده یا نماینده
...
در اکانتینگ ما نیاز به ثبت ریز تراکنش ها داریم مانند اینکه از چه درگاهی باشد ، تاریخ ثبت چه زمانی است ، بابت چی هست (شارژ کیف پول ، ثبت سفارش بوده و ...)مربوط چه سفارشی هست ، چه افرادی در این سفارش نقش داشته اند و غیره
