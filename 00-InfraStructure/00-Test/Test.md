...
تست ویژگی ها و رفتار عملیاتی یک محصول برای اطمینان از مطابقت آنها با مشخصات آن.
تستی  که تنها بر خروجی های تولید شده در پاسخ به ورودی های انتخابی و شرایط اجرا تمرکز می کند.
...
تست کاربردپذیری، سهولت استفاده  یک محصول را با استفاده از روش‌های استاندارد تست کاربر پذیری مشخص می‌کند.
